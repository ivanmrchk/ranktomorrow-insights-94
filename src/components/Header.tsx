          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="lg:hidden flex items-center gap-2">
              ...
              <button
                ...
                className="p-2.5 text-foreground rounded-lg hover:bg-secondary/80 transition-colors"
              >
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="lg:hidden relative bg-background/95 backdrop-blur-xl border-b border-border/50"
            >
